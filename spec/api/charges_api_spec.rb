...
describe 'ChargesApi' do
  ...
  describe 'charges_get test' do
    ...
    it 'should work' do
      res = api_instance.charges_get(config.access_token, "0.1.0", "application/json")
  ...
  describe "#charges_id_get" do
    ...
    it 'should work' do
      res = api_instance.charges_id_get(config.access_token, "0.1.0", "application/json", charge_id)
  ...
  describe "#charges_post" do
    ...
    it 'should work' do
      res = api_instance.charges_post(config.access_token, "0.1.0", "application/json", body)
