...
describe 'PaymentIntentsApi' do
  let(:api_instance) { BckbnPay::PaymentIntentsApi.new }
  ...
  describe 'confirm_payment_intent test' do
    let(:payment_method_id) { Faker::Alphanumeric.alphanumeric(number: 32) }

    before do
      stub_request(:post, [config.host, "#{path}/#{payment_method_id}/confirm"].join)
    ...
    it 'should work' do
      res = api_instance.confirm_payment_intent(api_version, payment_method_id)

      expect(res).to be_instance_of(BckbnPay::PaymentIntentResponse)
    end
  end
  ...
  describe 'capture_payment_intent test' do
    ...
    before do
      stub_request(:post, [config.host, "#{path}/#{payment_method_id}/capture"].join)
        .with(headers: request_headers)
        .to_return(
          status: 200,
    ...
    it 'should work' do
      res = api_instance.capture_payment_intent(api_version, payment_method_id)
  ...
  describe 'cancel_payment_intent test' do
    ...
    before do
      stub_request(:post, [config.host, "#{path}/#{payment_method_id}/cancel"].join)
        .with(headers: request_headers)
        .to_return(
          status: 200,
    ...
    it 'should work' do
      res = api_instance.cancel_payment_intent(api_version, payment_method_id)
  ...
  describe 'create_payment_intent test' do
    ...
    it 'should work' do
      res = api_instance.create_payment_intent(api_version, body)
  ...
  describe 'get_payment_intent test' do
    ...
    it 'should work' do
      res = api_instance.get_payment_intent(api_version, payment_intent_id)
  ...
  describe 'list_payment_intents test' do
    ...
    it 'should work' do
      res = api_instance.list_payment_intents(api_version)

      expect(res).to be_instance_of(BckbnPay::ListPaymentIntentsResponse)
    end
  end
  ...
  describe 'update_payment_intent test' do
    ...
    it 'should work' do
      res = api_instance.update_payment_intent(api_version, payment_intent_id, body)
