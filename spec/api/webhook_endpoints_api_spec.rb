...
# Unit tests for BckbnPay::WebhookEndpointsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WebhookEndpointsApi' do
  let(:api_instance) { BckbnPay::WebhookEndpointsApi.new }
  ...
  describe 'test an instance of WebhookEndpointsApi' do
    it 'should create an instance of WebhookEndpointsApi' do
      expect(api_instance).to be_instance_of(BckbnPay::WebhookEndpointsApi)
    end
  end
  ...
  describe 'create_webhook_endpoint test' do
    ...
    it 'should work' do
      ...
      expect(res).to be_instance_of(BckbnPay::WebhookEndpoint)
    end
  end
  ...
  describe 'list_webhook_endpoints test' do
    ...
    it 'should work' do
      ...
      expect(res).to be_instance_of(BckbnPay::ListWebhookEndpointsResponse)
    end
  end
