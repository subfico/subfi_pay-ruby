...
# Unit tests for BckbnPay::AccessKeysApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AccessKeysApi' do
  let(:api_instance) { BckbnPay::AccessKeysApi.new }
  ...
  describe 'test an instance of AccessKeysApi' do
    it 'should create an instance of AccessKeysApi' do
      expect(api_instance).to be_instance_of(BckbnPay::AccessKeysApi)
    end
  end
  ...
  describe 'list_access_keys test' do
    ...
    it 'should work' do
      ...
      expect(res).to be_instance_of(BckbnPay::ListAccessKeysResponse)
    end
  end
  ...
  describe 'roll_access_key test' do
    ...
    it 'should work' do
      ...
      expect(res).to be_instance_of(BckbnPay::AccessKey)
    end
  end
