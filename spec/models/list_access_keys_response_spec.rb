...
# Unit tests for BckbnPay::ListAccessKeysResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BckbnPay::ListAccessKeysResponse do
  let(:instance) { BckbnPay::ListAccessKeysResponse.new }

  describe 'test an instance of ListAccessKeysResponse' do
    it 'should create an instance of ListAccessKeysResponse' do
      expect(instance).to be_instance_of(BckbnPay::ListAccessKeysResponse)
    end
  end
