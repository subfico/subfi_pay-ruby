...
# Unit tests for BckbnPay::ListPaymentMethodsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BckbnPay::ListPaymentMethodsResponse do
  let(:instance) { BckbnPay::ListPaymentMethodsResponse.new }

  describe 'test an instance of ListPaymentMethodsResponse' do
    it 'should create an instance of ListPaymentMethodsResponse' do
      expect(instance).to be_instance_of(BckbnPay::ListPaymentMethodsResponse)
    end
  end
