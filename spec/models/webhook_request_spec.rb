...
# Unit tests for BckbnPay::WebhookRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BckbnPay::WebhookRequest do
  let(:instance) { BckbnPay::WebhookRequest.new }

  describe 'test an instance of WebhookRequest' do
    it 'should create an instance of WebhookRequest' do
      expect(instance).to be_instance_of(BckbnPay::WebhookRequest)
    end
  end
