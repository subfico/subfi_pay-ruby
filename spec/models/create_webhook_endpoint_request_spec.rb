...
# Unit tests for BckbnPay::CreateWebhookEndpointRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BckbnPay::CreateWebhookEndpointRequest do
  let(:instance) { BckbnPay::CreateWebhookEndpointRequest.new }
  ...
  describe 'test an instance of CreateWebhookEndpointRequest' do
    it 'should create an instance of CreateWebhookEndpointRequest' do
      expect(instance).to be_instance_of(BckbnPay::CreateWebhookEndpointRequest)
    end
  end
