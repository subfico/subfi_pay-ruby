...
# Unit tests for BckbnPay::AccessKey
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BckbnPay::AccessKey do
  let(:instance) { BckbnPay::AccessKey.new }

  describe 'test an instance of AccessKey' do
    it 'should create an instance of AccessKey' do
      expect(instance).to be_instance_of(BckbnPay::AccessKey)
    end
  end
