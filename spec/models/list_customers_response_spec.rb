...
# Unit tests for BckbnPay::ListCustomersResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe BckbnPay::ListCustomersResponse do
  let(:instance) { BckbnPay::ListCustomersResponse.new }

  describe 'test an instance of ListCustomersResponse' do
    it 'should create an instance of ListCustomersResponse' do
      expect(instance).to be_instance_of(BckbnPay::ListCustomersResponse)
    end
  end
