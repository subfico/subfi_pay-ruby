...
describe SubfiPay::ChargeResponse do
  ...
  let(:attributes) { %w[amount customer_id description metadata payment_intent_id payment_method_id id account_id state succeeded_at created_at updated_at type] }
