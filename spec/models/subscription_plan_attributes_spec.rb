...
# Unit tests for SubfiPay::SubscriptionPlanAttributes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SubfiPay::SubscriptionPlanAttributes do
  let(:instance) { SubfiPay::SubscriptionPlanAttributes.new }

  describe 'test an instance of SubscriptionPlanAttributes' do
    it 'should create an instance of SubscriptionPlanAttributes' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(SubfiPay::SubscriptionPlanAttributes)
    end
  end
