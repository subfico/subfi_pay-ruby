...
# Unit tests for SubfiPay::CardProfileAttributes
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SubfiPay::CardProfileAttributes do
  let(:instance) { SubfiPay::CardProfileAttributes.new }

  describe 'test an instance of CardProfileAttributes' do
    it 'should create an instance of CardProfileAttributes' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(SubfiPay::CardProfileAttributes)
    end
  end
