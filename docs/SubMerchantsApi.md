...
> <SubMerchant> sub_merchants_id_get(x_api_version, content_type, id)
...
begin
  # Retrieve a sub-merchant
  result = api_instance.sub_merchants_id_get(x_api_version, content_type, id)
  p result
...
> <Array(<SubMerchant>, Integer, Hash)> sub_merchants_id_get_with_http_info(x_api_version, content_type, id)

```ruby
begin
  # Retrieve a sub-merchant
  data, status_code, headers = api_instance.sub_merchants_id_get_with_http_info(x_api_version, content_type, id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SubMerchant>
rescue BckbnPay::ApiError => e
...
> <SubMerchant> sub_merchants_post(x_api_version, content_type, sub_merchants_post_request)
...
begin
  # Create a sub-merchant
  result = api_instance.sub_merchants_post(x_api_version, content_type, sub_merchants_post_request)
  p result
rescue BckbnPay::ApiError => e
...
> <Array(<SubMerchant>, Integer, Hash)> sub_merchants_post_with_http_info(x_api_version, content_type, sub_merchants_post_request)

```ruby
begin
  # Create a sub-merchant
  data, status_code, headers = api_instance.sub_merchants_post_with_http_info(x_api_version, content_type, sub_merchants_post_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SubMerchant>
rescue BckbnPay::ApiError => e
