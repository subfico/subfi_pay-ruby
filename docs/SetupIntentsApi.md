...
> <SetupIntentCreateResponse> create_setup_intent(x_api_version, x_account_id, setup_intent_create_request)
...
> <Array(<SetupIntentCreateResponse>, Integer, Hash)> create_setup_intent_with_http_info(x_api_version, x_account_id, setup_intent_create_request)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <SetupIntentCreateResponse>
rescue SubfiPay::ApiError => e
...
[**SetupIntentCreateResponse**](SetupIntentCreateResponse.md)
