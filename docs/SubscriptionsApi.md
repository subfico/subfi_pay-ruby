...
> <ListSubscriptionResponse> list_subscriptions(x_api_version, x_account_id, opts)
...
> <Array(<ListSubscriptionResponse>, Integer, Hash)> list_subscriptions_with_http_info(x_api_version, x_account_id, opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ListSubscriptionResponse>
rescue SubfiPay::ApiError => e
