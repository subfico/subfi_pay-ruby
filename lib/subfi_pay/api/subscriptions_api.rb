...
module SubfiPay
  class SubscriptionsApi
    ...
    # @option opts [Integer] :page The page of results to retrieve.
    # @option opts [Integer] :per_page Number of results per page.
    # @return [Array<(ListSubscriptionResponse, Integer, Hash)>] ListSubscriptionResponse data, response status code and response headers
    def list_subscriptions_with_http_info(x_api_version, x_account_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ListSubscriptionResponse'
