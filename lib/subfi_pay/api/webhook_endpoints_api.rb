...
module SubfiPay
  class WebhookEndpointsApi
    ...
    def create_webhook_endpoint(x_api_version, webhook_endpoint_create_request, opts = {})
      data, _status_code, _headers = create_webhook_endpoint_with_http_info(x_api_version, webhook_endpoint_create_request, opts)
      data
    end
    ...
    def create_webhook_endpoint_with_http_info(x_api_version, webhook_endpoint_create_request, opts = {})
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def delete_webhook_endpoint(x_api_version, id, opts = {})
      delete_webhook_endpoint_with_http_info(x_api_version, id, opts)
      nil
    end
    ...
    def delete_webhook_endpoint_with_http_info(x_api_version, id, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [WebhookEndpointResponse]
    def get_webhook_endpoint(x_api_version, id, opts = {})
      data, _status_code, _headers = get_webhook_endpoint_with_http_info(x_api_version, id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WebhookEndpointResponse, Integer, Hash)>] WebhookEndpointResponse data, response status code and response headers
    def get_webhook_endpoint_with_http_info(x_api_version, id, opts = {})
      if @api_client.config.debugging
    ...
    def list_webhook_endpoints(x_api_version, opts = {})
      data, _status_code, _headers = list_webhook_endpoints_with_http_info(x_api_version, opts)
      data
    end
    ...
    def list_webhook_endpoints_with_http_info(x_api_version, opts = {})
      if @api_client.config.debugging
    ...
    # @param [Hash] opts the optional parameters
    # @return [WebhookEndpointResponse]
    def update_webhook_endpoint(x_api_version, id, webhook_endpoint_create_request, opts = {})
      data, _status_code, _headers = update_webhook_endpoint_with_http_info(x_api_version, id, webhook_endpoint_create_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WebhookEndpointResponse, Integer, Hash)>] WebhookEndpointResponse data, response status code and response headers
    def update_webhook_endpoint_with_http_info(x_api_version, id, webhook_endpoint_create_request, opts = {})
      if @api_client.config.debugging
