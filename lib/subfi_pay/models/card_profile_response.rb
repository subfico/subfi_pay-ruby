...
module SubfiPay
  class CardProfileResponse
    ...
    def hash
      [avs_check, avs_check_message, brand, cvc_check, cvc_check_message, exp_month, exp_year, first6, funding, last4, state, three_d_secure_supported, token, wallet_provider, created_at, updated_at].hash
    end
