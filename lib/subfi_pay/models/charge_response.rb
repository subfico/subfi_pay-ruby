...
module SubfiPay
  class ChargeResponse
    ...
    def valid?
      ...
      state_validator = EnumAttributeValidator.new('String', ["requires_confirmation", "processing", "requires_capture", "succeeded", "failed", "errored", "cancelled"])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ["requires_confirmation", "processing", "requires_capture", "succeeded", "failed", "errored", "cancelled"])
    ...
    def hash
      [id, account_id, adjustment_reason, amount, currency, customer_id, description, allowed_reverse_action, metadata, original_transaction_id, parent_transaction_id, payment_intent_id, payment_method_id, platform_fee, platform_per_txn_fee, platform_rate, source, state, statement_descriptor, succeeded_at, created_at, updated_at].hash
    end
