...
module SubfiPay
  class ChargeResponse
    ...
    def hash
      [id, account_id, adjustment_reason, amount, currency, customer_id, description, metadata, original_transaction_id, payment_intent_id, payment_method_id, platform_fee, platform_per_txn_fee, platform_rate, processor_authorization_id, processor_capture_id, processor_data, processor_refund_id, processor_sale_id, processor_void_id, state, statement_descriptor, succeeded_at, created_at, updated_at, reversal_action].hash
    end
