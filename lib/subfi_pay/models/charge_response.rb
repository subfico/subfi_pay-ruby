...
module SubfiPay
  class ChargeResponse
    ...
    attr_accessor :in_refund_window

    attr_accessor :in_void_window
    ...
    def self.attribute_map
      {
        ...
        :'in_refund_window' => :'in_refund_window',
    ...
    def self.openapi_types
      {
        ...
        :'customer_id' => :'String',
        :'description' => :'String',
        :'in_refund_window' => :'Boolean',
        :'in_void_window' => :'Boolean',
        :'metadata' => :'Object',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'in_refund_window')
        self.in_refund_window = attributes[:'in_refund_window']
      end

      if attributes.key?(:'in_void_window')
        self.in_void_window = attributes[:'in_void_window']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          in_refund_window == o.in_refund_window &&
          in_void_window == o.in_void_window &&
          metadata == o.metadata &&
    ...
    def hash
      [id, account_id, adjustment_reason, amount, currency, customer_id, description, in_refund_window, in_void_window, metadata, original_transaction_id, payment_intent_id, payment_method_id, platform_fee, platform_per_txn_fee, platform_rate, source, state, statement_descriptor, succeeded_at, created_at, updated_at].hash
    end
