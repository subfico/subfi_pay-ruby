...
module SubfiPay
  class ProcessorTransactionResponse
    ...
    def hash
      [id, account_id, approved, external_reference, metadata, payment_method_id, payment_transaction_id, processor_id, processor_transaction_id, transaction_type, created_at, updated_at].hash
    end
