...
module SubfiPay
  class ProcessorTransactionResponse
    attr_accessor :id
    ...
    attr_accessor :accounts_processor_id
    ...
    def self.attribute_map
      {
        ...
        :'accounts_processor_id' => :'accounts_processor_id',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SubfiPay::ProcessorTransactionResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SubfiPay::ProcessorTransactionResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'accounts_processor_id')
        self.accounts_processor_id = attributes[:'accounts_processor_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          accounts_processor_id == o.accounts_processor_id &&
    ...
    def hash
      [id, account_id, approved, avs_check, avs_check_message, cvc_check, cvc_check_message, external_reference, metadata, payment_method_id, payment_transaction_id, payment_transaction_type, accounts_processor_id, processor_transaction_id, processor_reference, transaction_type, created_at, updated_at].hash
    end
