...
module SubfiPay
  class ProcessorTransactionResponse
    ...
    def hash
      [id, account_id, approved, avs_check, avs_check_message, cvc_check, cvc_check_message, external_reference, metadata, payment_method_id, payment_transaction_id, payment_transaction_type, accounts_processor_id, processor_transaction_id, transaction_type, created_at, updated_at].hash
    end
