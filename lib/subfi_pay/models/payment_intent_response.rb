...
module SubfiPay
  class PaymentIntentResponse
    ...
    def valid?
      ...
      state_validator = EnumAttributeValidator.new('String', ["requires_payment_method", "requires_confirmation", "requires_capture", "processing_authorization", "processing_capture", "processing_sale", "requires_review", "succeeded", "cancelled"])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ["requires_payment_method", "requires_confirmation", "requires_capture", "processing_authorization", "processing_capture", "processing_sale", "requires_review", "succeeded", "cancelled"])
