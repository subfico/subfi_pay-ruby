...
module SubfiPay
  class PaymentIntentResponse
    ...
    def hash
      [id, account_id, amount, capture_method, currency, customer_id, description, metadata, payment_method, source, state, statement_descriptor, created_at, updated_at].hash
    end
