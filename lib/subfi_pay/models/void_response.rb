...
module SubfiPay
  class VoidResponse
    ...
    def hash
      [id, account_id, adjustment_reason, amount, currency, customer_id, description, metadata, original_transaction_id, payment_intent_id, payment_method_id, platform_fee, platform_per_txn_fee, platform_rate, source, state, statement_descriptor, succeeded_at, created_at, updated_at].hash
    end
