...
module BckbnPay
  class AccessKeysApi
    ...
    # @param x_api_version [String] 
    # @param id [String] 
    # @param roll_access_key_request [RollAccessKeyRequest] 
    # @param [Hash] opts the optional parameters
    # @return [AccessKey]
    def roll_access_key(x_api_version, id, roll_access_key_request, opts = {})
      data, _status_code, _headers = roll_access_key_with_http_info(x_api_version, id, roll_access_key_request, opts)
      data
    end
    ...
    def roll_access_key_with_http_info(x_api_version, id, roll_access_key_request, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'roll_access_key_request' is set
      if @api_client.config.client_side_validation && roll_access_key_request.nil?
        fail ArgumentError, "Missing the required parameter 'roll_access_key_request' when calling AccessKeysApi.roll_access_key"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(roll_access_key_request)
