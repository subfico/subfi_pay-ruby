...
module BckbnPay
  class WebhookEndpointsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [WebhookEndpoint]
    def update_webhook_endpoint(x_api_version, id, create_webhook_endpoint_request, opts = {})
      data, _status_code, _headers = update_webhook_endpoint_with_http_info(x_api_version, id, create_webhook_endpoint_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(WebhookEndpoint, Integer, Hash)>] WebhookEndpoint data, response status code and response headers
    def update_webhook_endpoint_with_http_info(x_api_version, id, create_webhook_endpoint_request, opts = {})
      if @api_client.config.debugging
