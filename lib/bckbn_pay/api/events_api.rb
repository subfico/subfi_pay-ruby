...
module BckbnPay
  class EventsApi
    ...
    # @return [Event]
    def get_event(x_api_version, id, opts = {})
      data, _status_code, _headers = get_event_with_http_info(x_api_version, id, opts)
      data
    end
    ...
    def get_event_with_http_info(x_api_version, id, opts = {})
    ...
    def list_events(x_api_version, opts = {})
      data, _status_code, _headers = list_events_with_http_info(x_api_version, opts)
      data
    end
    ...
    def list_events_with_http_info(x_api_version, opts = {})
      if @api_client.config.debugging
