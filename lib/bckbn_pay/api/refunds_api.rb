...
module BckbnPay
  class RefundsApi
    ...
    # @return [Refund]
    def refunds_post(x_api_version, content_type, refunds_post_request, opts = {})
      data, _status_code, _headers = refunds_post_with_http_info(x_api_version, content_type, refunds_post_request, opts)
      data
    end
    ...
    def refunds_post_with_http_info(x_api_version, content_type, refunds_post_request, opts = {})
