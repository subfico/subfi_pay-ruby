...
module BckbnPay
  class SubMerchantsApi
    ...
    # @return [SubMerchant]
    def sub_merchants_id_get(x_api_version, content_type, id, opts = {})
      data, _status_code, _headers = sub_merchants_id_get_with_http_info(x_api_version, content_type, id, opts)
      data
    end
    ...
    def sub_merchants_id_get_with_http_info(x_api_version, content_type, id, opts = {})
    ...
    # @param [Hash] opts the optional parameters
    # @return [SubMerchant]
    def sub_merchants_post(x_api_version, content_type, sub_merchants_post_request, opts = {})
      data, _status_code, _headers = sub_merchants_post_with_http_info(x_api_version, content_type, sub_merchants_post_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(SubMerchant, Integer, Hash)>] SubMerchant data, response status code and response headers
    def sub_merchants_post_with_http_info(x_api_version, content_type, sub_merchants_post_request, opts = {})
      if @api_client.config.debugging
