...
module BckbnPay
  class PaymentMethodsApi
    ...
    def payment_methods_id_get(x_api_version, content_type, id, opts = {})
      data, _status_code, _headers = payment_methods_id_get_with_http_info(x_api_version, content_type, id, opts)
      data
    end
    ...
    def payment_methods_id_get_with_http_info(x_api_version, content_type, id, opts = {})
    ...
    # @param [Hash] opts the optional parameters
    # @return [PaymentMethod]
    def payment_methods_post(x_api_version, content_type, payment_methods_post_request, opts = {})
      data, _status_code, _headers = payment_methods_post_with_http_info(x_api_version, content_type, payment_methods_post_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(PaymentMethod, Integer, Hash)>] PaymentMethod data, response status code and response headers
    def payment_methods_post_with_http_info(x_api_version, content_type, payment_methods_post_request, opts = {})
      if @api_client.config.debugging
