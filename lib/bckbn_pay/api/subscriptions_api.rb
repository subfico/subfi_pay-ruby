...
module BckbnPay
  class SubscriptionsApi
    ...
    def create_subscription(x_api_version, subscription_create_request, opts = {})
      data, _status_code, _headers = create_subscription_with_http_info(x_api_version, subscription_create_request, opts)
      data
    end
    ...
    def create_subscription_with_http_info(x_api_version, subscription_create_request, opts = {})
    ...
    # @param [Hash] opts the optional parameters
    # @return [SubscriptionResponse]
    def get_subscription(x_api_version, id, opts = {})
      data, _status_code, _headers = get_subscription_with_http_info(x_api_version, id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(SubscriptionResponse, Integer, Hash)>] SubscriptionResponse data, response status code and response headers
    def get_subscription_with_http_info(x_api_version, id, opts = {})
      if @api_client.config.debugging
