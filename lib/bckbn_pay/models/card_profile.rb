...
module BckbnPay
  class CardProfile
    ...
    def hash
      [encrypted_card_number, exp_month, exp_year, cvc, avs_check, avs_check_message, brand, cvc_check, cvc_check_message, funding, last4, three_d_secure_supported, token].hash
    end
