...
*SubfiPay::FraudRulesApi* | [**create_fraud_rule**](docs/FraudRulesApi.md#create_fraud_rule) | **POST** /fraud_rules | Create a Fraud Rule
*SubfiPay::FraudRulesApi* | [**delete_fraud_rule**](docs/FraudRulesApi.md#delete_fraud_rule) | **DELETE** /fraud_rules/{id} | Delete a Fraud Rule by ID
*SubfiPay::FraudRulesApi* | [**list_fraud_rules**](docs/FraudRulesApi.md#list_fraud_rules) | **GET** /fraud_rules | List all fraud rules
...
*SubfiPay::ProcessorApi* | [**get_processor**](docs/ProcessorApi.md#get_processor) | **GET** /processors/{id} | Retrieve a processor
...
## Documentation for Models
 ...
 - [SubfiPay::FraudRuleAttributes](docs/FraudRuleAttributes.md)
 - [SubfiPay::FraudRuleCreateRequest](docs/FraudRuleCreateRequest.md)
 - [SubfiPay::FraudRuleResponse](docs/FraudRuleResponse.md)
 ...
 - [SubfiPay::ListFraudRulesResponse](docs/ListFraudRulesResponse.md)
 ...
 - [SubfiPay::ProcessorResponse](docs/ProcessorResponse.md)
